...
- 2026-07-14：跨平台打包统一调用 `s840207702/cross-platform-release-workflows@v1`；手动运行只生成 Actions Artifact，推送 `v*` 标签时由 Windows、macOS、Linux 原生 Runner 构建并在全部成功后发布同一个 Release。
